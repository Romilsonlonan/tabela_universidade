...
nome_escola = "UNIVERSIDADE ANHANGUERA"
...
while cadastrar_aluno == 's':
    ...
    aluno["Faculdade"] = input("digite a faculdade atual:")
    aluno["Confirmar Cadastro"] = input("Cadastro com Sucesso!!!")
    '''    
...
#os.system(comando_abrir_aquivo)
